...
const translations: Record<Language, Record<string, string>> = {
  ...
  tr: {
    ...
    // About Us Page Translations
    'aboutus.hero.title': 'Sıfırdan',
    'aboutus.hero.mastery': 'Ustalığa',
    'aboutus.hero.description': 'Sadece berberlik öğretmiyoruz — kariyerler şekillendiriyoruz. Hırs, sınıflarımızda hassasiyetle buluşuyor.',
    'aboutus.legal.title': 'Yasal Bilgiler',
    'aboutus.legal.name': 'Yasal Adı:',
    'aboutus.legal.trading': 'Ticari Adı:',
    'aboutus.offers.title': 'Neler Sunuyoruz',
    'aboutus.offers.beginners.title': 'Yeni Başlayanlar İçin',
    'aboutus.offers.beginners.text': 'Sıfırdan yeni kariyerinizi başlatmak için temel kurslar.',
    'aboutus.offers.experienced.title': 'Deneyimli Berberler İçin',
    'aboutus.offers.experienced.text': 'Tekniği geliştirmek ve statüyü yükseltmek için ileri düzey modüller.',
    'aboutus.whychoose.title': 'Neden Seçin',
    'aboutus.whychoose.reason1': 'Gerçek müşteriler ve mankenlerde %80 uygulamalı pratik',
    'aboutus.whychoose.reason2': 'Kişiselleştirilmiş mentorluk için küçük gruplar',
    'aboutus.whychoose.reason3': 'Tüm araçlar ve ürünler sağlanır — gizli maliyet yok',
    'aboutus.whychoose.reason4': 'Tamamlandığında tanınan sertifikalar',
    'aboutus.whychoose.reason5': '%100\'e varan finansal destek sağlamada yardım',
    'aboutus.team.title': 'Takımla',
    'aboutus.team.team': 'Tanışın',
    'aboutus.results.title': 'Konuşan Sonuçlar',
    'aboutus.results.graduates': 'Polonya genelinde çalışan 100+ mezun',
    'aboutus.results.trusted': 'Sürekli eğitim için profesyoneller tarafından güvenilen',
    'aboutus.results.reviews': 'Google ve Booksy\'de 5 yıldızlı değerlendirmeler',
    'aboutus.faq.title': 'Sık Sorulan Sorular',
    'aboutus.faq.q1': 'Daha önce hiç makas tutmadım – yapabilir miyim?',
    'aboutus.faq.a1': 'Kesinlikle. Birçok öğrenci sıfırdan başlar; temel programımız yeni başlayanlar için tasarlanmıştır.',
    'aboutus.faq.q2': 'Kurs pahalı mı?',
    'aboutus.faq.a2': 'Temel fiyat 11.000 PLN, şu anda 9.000 PLN\'ye indirimli. Günlük atölyeler 1.200 PLN\'den başlar.',
    'aboutus.cta.enroll': 'Şimdi Kayıt Ol',
