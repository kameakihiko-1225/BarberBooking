...
const translations: Record<Language, Record<string, string>> = {
  ...
  uk: {
    ...
    'course.duration.4hours': '4 години',
    'course.duration.1month': '1 місяць',
    'course.duration.3days': '3 дні',
    'course.duration.2weeks': '2 тижні',
    ...
    'page.gallery.explore': 'Досліджуйте нашу повну колекцію з ${count} професійних робіт та навчальних матеріалів',
